		...
		<div class="content-inner">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li class="last"><s:text name="navigate.cart"/></li>
				</ul>
				<br class="clear"/>
			</div>
			...
			<div class="full-width-content">
				<h3><s:text name="cart.menu"/></h3>
				<table cellpadding="0" cellspacing="0">
					<tr>
						<td class="remove"><span class="heading"><s:text name="cart.remove"/></span></td>
						<td class="thumbnail" width="200px"></td>
						<td class="product-name" style="text-align: center"><span class="heading"><s:text name="cart.name"/></span></td>
						<td class="unit-price"></td>
						<td class="quantity"><span class="heading"><s:text name="cart.color"/></span></td>
						<td class="price"><span class="heading"><s:text name="cart.price"/></span></td>
					</tr>
                        ...
                        <tr>
                            ...
                            <td class="thumbnail" width="200px" style="text-align: right"><a href="details_${cart.product.id}.html" target="_blank">
                                <c:forEach items="${cart.product.picPath}" var="pic" begin="0" end="0">
                                    <img src="${pwk:getPicDomain()}/${pic.path}" style="width: 80px;height: 80px;"/>
                                </c:forEach>
                            </a></td>
                            ...
                            <td class="price">RM <fmt:formatNumber value="${cart.product.price}" type="currency" pattern="###,##0.00"/></td>
                        </tr>
                    </c:forEach>
					<tr class="promo">
					...
					<tr>
						<td colspan="4" class="unit-price"></td>
						<td class="quantity"><span class="summary"><s:text name="cart.total"/></span></td>
					...
					<tr class="last submit">
						...
						<td class="price">
							<a href="${pageContext.request.contextPath}/orderConfirm.html" class="general-button-big cart-button"><span class="button-big"><s:text name="cart.submit"/></span></a>
						</td>
					</tr>
				</table>
			</div>

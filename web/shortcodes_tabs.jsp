		...
		<div class="content-inner">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li class="last">Tabs and Accordions</li>
				</ul>
				<br class="clear"/>
			</div>
			...
			<div class="full-width-content">
				...
				<!-- Normal Tab Section End -->
				
				<!-- Simpler Tab Section Begin -->
				...
				<div class="sh-one-half float-left">
					<div id="accordion">
						...
						<h2 class="current">Accordion One</h2>
				...
				<div class="sh-one-half column-last float-right">
					<div id="accordion-simple">
						...
						<div class="pane">
							<!-- Accordion 1 section -->
								<p>Aliquam ac libero elit. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Nulla metus libero, rhoncus nec mattis ac, ullamcorper interdum elit. Nullam id congue est. Nam diam dui, accumsan quis pretium et, facilisis ut leo. Sed orci diam, dictum ut aliquet eget, sodales in massa. Aliquam ac libero elit. </p>
							<!-- End -->
						</div>

		...
		<div class="content-inner">
			...
			<div class="breadcrumbs">
				<ul>
					...
					<li><a href="grid_0.html"><s:text name="navigate.product.detail.all"/></a></li>
				...
				<div class="detail-item">
							...
							<div class="panel">	
								...
								<ul id="images">
                                    <c:forEach items="${product.picPath}" var="pic" begin="0" end="3">
                                        <li><a href="${pwk:getPicDomain()}/${pic.path}"><img src="${pwk:getPicDomain()}/${pic.path}" title="Home made"/></a></li>
                                    </c:forEach>
								</ul>
							</div>	
						</div>
			 		...
			 		<div class="text-info">
						...
						<div class="dropdown-container">
							<span class="size"><s:text name="cart.color"/>:</span>
							<!-- Dropdown Begin -->
							<div class="color">
								<div class="dropdown">
						...
						<div class="float-left dropdown-container">
							<c:if test="${product.stockStatus eq 1}">
								<a href="javascript:void(0)" onclick="addToCart(${product.id},'1');" class="general-button-big"><span class="button-big"><s:text name="product.cart"/></span></a>
								<a href="javascript:void(0)" onclick="buyNow(${product.id},'1');" class="general-button-big"><span class="button-big"><s:text name="product.buy"/></span></a>
							</c:if>
							<c:if test="${product.stockStatus eq 0}">
								<a href="javascript:void(0)" class="general-button-big"><span class="button-big"><s:text name="product.stock"/></span></a>
							</c:if>
						</div>
					...
					<div id="tabbed-menu">
						<ul class="tabs">
							<li><a href="#"><s:text name="product.description"/></a></li>

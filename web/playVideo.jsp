...
<title>Video &middot; Web Shop</title>
<!-- Main style -->
		...
		<div class="content-inner">
			...
			<div class="main-content">
				...
				<a name="top"></a>
					...
					<ul class="faq-item">
                        <embed src="${video.link}" width="709" height="600" quality="high" align="middle" allowScriptAccess="always" allowFullScreen="true" mode="transparent" type="application/x-shockwave-flash"></embed>
					</ul>

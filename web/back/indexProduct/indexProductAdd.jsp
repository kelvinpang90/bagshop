...
<html>
<head>
    <title>Add Index Product</title>
</head>
<body>
    <form action="${pageContext.request.contextPath}/indexProduct/addIndexProduct.do" method="post" class="bs-example bs-example-form" role="form"
